...
import (
	...
	contracts "github.com/rvadym/hyperledger-fabric-test/application/contracts"
...
func (m *MockFetchItemsRepoInterface) FetchItems(filter *contracts.Filter) ([]*domain.Item, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchItems", filter)
...
func (mr *MockFetchItemsRepoInterfaceMockRecorder) FetchItems(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchItems", reflect.TypeOf((*MockFetchItemsRepoInterface)(nil).FetchItems), filter)
}
